              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form:form id="form" cssClass="forms-sample" action="saveActivity" method="post" modelAttribute="activity" enctype='multipart/form-data' >
                    ...
                    <div class="form-group">
						<img id="blah" src="<c:url value='/localImage/defaultHeadshot.jpg'/>" style="display:block;width: 180px;" />
						<label for="productImage">活動照片</label>
                    	<form:input path="productImage" type='file' cssClass="form-control" id="ac_image" onchange="previewHeadshot(event)" accept="image/*"/>
                     </div>
<!--                     <div class="form-group"> -->
<!--                     <label for="ac_image"> <span>活動照片</span>  -->
<%-- 					<img id="blah" src="<c:url value='localImage/defaultImage.jpg'/>" style="width:200px" alt="choose one"> --%>
<%--  					<form:input type="file" path="ac_image" cssClass="form-control" id="ac_image" onchange="previewImage(event)" accept="image/*"/>  --%>
<!-- 					</label> -->
<!--                     </div> -->
                    <div class="form-group">
